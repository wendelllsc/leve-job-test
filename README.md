...
1. Executar Script de criação do banco de dados
...
2. Se necessário, você pode mudar as configurações de conexão com o banco de dado em "src/config/database.js"
